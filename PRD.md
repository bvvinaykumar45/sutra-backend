...
Sutra Backend is a RESTful API service designed to support collaborative project management. The system enables teams to organize projects, manage tasks with subtasks, maintain project notes, and handle user authentication with role-based access control.
...
- **Task Updates:** Modify task informtion and status
...
- JWT-based authenticaton with refresh tokens
